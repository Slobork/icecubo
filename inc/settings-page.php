...
function icecubo_settings_navigation_select_class_5_callback() {
    ...
    echo '<option value="ice-submenu-shade-natural" ' . selected('', 'ice-submenu-shade-natural', false) . '>Shade Natural</option>';
    echo '<option value="ice-submenu-shade-deep" ' . selected('', 'ice-submenu-shade-deep', false) . '>Shade Deep</option>';
    echo '<option value="ice-submenu-shade-sharp" ' . selected('', 'ice-submenu-shade-sharp', false) . '>Shade Sharp</option>';
    echo '<option value="ice-submenu-shade-outlined" ' . selected('', 'ice-submenu-shade-outlined', false) . '>Shade Outlined</option>';
    echo '<option value="ice-submenu-shade-crisp" ' . selected('', 'ice-submenu-shade-crisp', false) . '>Shade Crisp</option>';
    echo '<option value="ice-submenu-shade-mild" ' . selected('', 'ice-submenu-shade-mild', false) . '>Shade Mild</option>';
    echo '<option value="ice-submenu-shade-tiny" ' . selected('', 'ice-submenu-shade-tiny', false) . '>Shade Tiny</option>';
    echo '<option value="ice-submenu-shade-large" ' . selected('', 'ice-submenu-shade-large', false) . '>Shade Large</option>';
    echo '</select>';
}
