...
// phpcs:ignore
/**
 * Title: Two columns CTA above full width image as placeholders.
 * Slug: icecubo/two-columns-cta-above-fullwidth-img
...
<h2 class="has-highlight-2-color has-text-color"></h2>
<!-- /wp:heading -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:35%"><!-- wp:paragraph {"textColor":"white"} -->
