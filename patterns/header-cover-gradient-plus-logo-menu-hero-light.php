 ...
 */
?>
<!-- wp:cover {"dimRatio":60,"gradient":"primary-to-transparent-rushly-radial","contentPosition":"center center","align":"full","style":{"spacing":{"padding":{"bottom":"5rem"}},"elements":{"link":{"color":{"text":"var:preset|color|darko-down"}},"heading":{"color":{"text":"var:preset|color|matching-6"}}}},"textColor":"darko-down"} -->
...
<!-- wp:heading {"textAlign":"center","level":1,"className":"is-style-default"} -->
<h1 class="wp-block-heading has-text-align-center is-style-default">IceCubo WordPress Theme</h1>
<!-- /wp:heading -->
...
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile"><div class="wp-block-media-text__content"><!-- wp:heading -->
