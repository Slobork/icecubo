 ...
 */
?>
<!-- wp:cover {"dimRatio":30,"minHeight":100,"gradient":"primary-to-transparent-rushly-radial","contentPosition":"center center","isDark":false,"tagName":"header","align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|darko-down"}}}},"className":"has-darko-down-color has-text-color has-link-color"} -->
...
<!-- wp:navigation {y"className":"is-style-icecubo-nav-mark-hovers","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right","orientation":"horizontal","flexWrap":"nowrap"},"style":{"spacing":{"margin":{"top":"0"},"blockGap":"var:preset|spacing|small"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></header>
<!-- /wp:cover -->