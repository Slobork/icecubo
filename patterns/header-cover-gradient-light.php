 ...
 */
?>
<!-- wp:cover {"dimRatio":30,"minHeight":100,"gradient":"primary-to-transparent-rushly-radial","contentPosition":"center center","isDark":false,"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|darko-down"}}}},"className":"has-darko-down-color has-text-color has-link-color"} -->
