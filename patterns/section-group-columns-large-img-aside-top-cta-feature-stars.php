...
<div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"spacing":{"padding":{"top":"10px","bottom":"10px","left":"var:preset|spacing|xx-small","right":"var:preset|spacing|xx-small"}},"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"primary","textColor":"white","className":"is-style-icecubo-highlight-p","fontSize":"small"} -->
<p class="has-text-align-center is-style-icecubo-highlight-p has-white-color has-primary-background-color has-text-color has-background has-link-color has-small-font-size" style="padding-top:10px;padding-right:var(--wp--preset--spacing--xx-small);padding-bottom:10px;padding-left:var(--wp--preset--spacing--xx-small);font-style:normal;font-weight:700">Built with IceCubo</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"style":{"spacing":{"margin":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}},"className":"is-style-icecubo-accent-text-huge-2"} -->
<h2 class="wp-block-heading is-style-icecubo-accent-text-huge-2" style="margin-top:var(--wp--preset--spacing--large);margin-bottom:var(--wp--preset--spacing--large)">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"textColor":"white","gradient":"darko-to-primary-radial-gradual","width":50,"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"className":"is-style-icecubo-highlight-up-button"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-icecubo-highlight-up-button"><a class="wp-block-button__link has-white-color has-darko-to-primary-radial-gradual-gradient-background has-text-color has-background has-link-color wp-element-button">Get Started Today</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<div class="wp-block-group"><!-- wp:paragraph {"textColor":"primary","fontSize":"large"} -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/ice-orange-straw.jpeg","dimRatio":0,"minHeight":830,"minHeightUnit":"px","isDark":false,"style":{"color":{"duotone":"unset"},"border":{"radius":"20px","width":"5px"}},"borderColor":"primary","className":"is-style-default"} -->
<div class="wp-block-cover is-light is-style-default has-border-color has-primary-border-color" style="border-width:5px;border-radius:20px;min-height:830px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url(get_theme_file_uri('/assets/img/ice-orange-straw.jpeg')); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
