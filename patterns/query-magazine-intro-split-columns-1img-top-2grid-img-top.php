 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["icecubo-query-magazine-intro"],"patternName":"icecubo/query-magazine-intro-split-columns-1img-top-2grid-img-top","name":"Offset split posts: 1st prominent column with image at the top. 2nd grid of posts with image at the top."},"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|x-large"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"darko-down-bottom","layout":{"type":"default"}} -->
<div class="wp-block-group has-darko-down-bottom-color has-text-color has-link-color" style="margin-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:columns {"verticalAlignment":"top","align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}}} -->
...
<div class="wp-block-query"><!-- wp:post-template {"className":"is-style-default","style":{"spacing":{"blockGap":"var:preset|spacing|xxx-small"}},"layout":{"type":"default"}} -->
