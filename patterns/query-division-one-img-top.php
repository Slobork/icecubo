 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["icecubo-query-division-one"],"patternName":"icecubo/query-division-one-img-top","name":"Posts wrapped in a group - Featured image at top."},"style":{"spacing":{"margin":{"top":"var:preset|spacing|xxx-large"}}},"layout":{"type":"default"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium"}},"border":{"radius":{"bottomLeft":"3px","bottomRight":"3px","topLeft":"0px","topRight":"0px"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"backgroundColor":"white-ice","textColor":"darko-down-bottom"} -->
