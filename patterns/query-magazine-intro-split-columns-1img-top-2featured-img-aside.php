 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["icecubo-query-magazine-intro"],"patternName":"icecubo/query-magazine-intro-split-columns-1img-top-2featured-img-aside","name":"Offset split posts: 1st prominent column with image the top. 2nd list with featured image aside."},"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|x-large"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"darko-down-bottom","layout":{"type":"default"}} -->
<div class="wp-block-group has-darko-down-bottom-color has-text-color has-link-color" style="margin-bottom:var(--wp--preset--spacing--x-large)"><!-- wp:columns {"align":"wide"} -->
...
<!-- wp:group {"className":"has-white-ice-background-color has-background","style":{"border":{"radius":{"topLeft":"0px","topRight":"0px","bottomLeft":"3px","bottomRight":"3px"}}}} -->
<div class="wp-block-group has-white-ice-background-color has-background" style="border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:3px;border-bottom-right-radius:3px"><!-- wp:post-title {"isLink":true,"className":"is-style-default","style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"xl"} /-->
...
<!-- wp:group {"className":"has-extra-small-font-size","style":{"spacing":{"blockGap":".5rem"},"fontSize":"extra-small"},"layout":{"type":"flex"}} -->
...
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:query {"queryId":0,"query":{"pages":0,"offset":"2","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","type":"constrained","inherit":false,"perPage":"3"},"layout":{"type":"default"}} -->
<div class="wp-block-query"><!-- wp:post-template {"className":"is-style-default","layout":{"type":"default","columnCount":3}} -->
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"width":"33.33%"} -->
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:post-featured-image {"isLink":true,"aspectRatio":"2/3","width":"100%","height":"200px","style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"border":{"width":"0px","style":"none","radius":{"topLeft":"3px","topRight":"3px","bottomLeft":"3px","bottomRight":"3px"}}}} /--></div>
<!-- /wp:column -->
