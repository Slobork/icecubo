...
// phpcs:ignore
/**
 * Title: Media and text as a call to action with heading and left aligned (Light background).
 * Slug: icecubo/hero-media-text-cta-left-aligned-light
 * Categories: icecubo-hero
 */
?>
<!-- wp:cover {"dimRatio":60,"gradient":"primary-to-transparent-rushly-radial","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}},"elements":{"link":{"color":{"text":"var:preset|color|darko-down"}},"heading":{"color":{"text":"var:preset|color|highlight-1"}}}},"textColor":"darko-down"} -->
