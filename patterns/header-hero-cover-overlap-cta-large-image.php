 ...
 */
?>
<!-- wp:cover {"dimRatio":20,"gradient":"primary-light-transparent-sharp-stack","contentPosition":"center center","isDark":false,"metadata":{"categories":["icecubo-header"],"patternName":"icecubo/header-hero-cover-overlap-cta-large-image","name":"Header with hero. Call to action with large image. Overlapping cover background."},"align":"full","style":{"spacing":{"padding":{"bottom":"6rem","top":"var:preset|spacing|small"}},"elements":{"link":{"color":{"text":"var:preset|color|hero-contrast-2"}},"heading":{"color":{"text":"var:preset|color|classy-3"}}}},"textColor":"hero-contrast-2","layout":{"type":"constrained"}} -->
...
<div class="wp-block-buttons" style="margin-bottom:var(--wp--preset--spacing--medium)"><!-- wp:button {"backgroundColor":"classy-3","textColor":"hero-contrast-3","className":"is-style-fill","style":{"elements":{"link":{"color":{"text":"var:preset|color|hero-contrast-3"}}},"border":{"width":"4px"}},"borderColor":"hero-contrast-3"} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-hero-contrast-3-color has-classy-3-background-color has-text-color has-background has-link-color has-border-color has-hero-contrast-3-border-color wp-element-button" style="border-width:4px">Start Now!</a></div>
<!-- /wp:button -->
