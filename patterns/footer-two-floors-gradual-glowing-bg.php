 ...
 */
?>
<!-- wp:cover {"dimRatio":50,"gradient":"primary-to-transparent-rushly-radial","isDark":false,"tagName":"footer","metadata":{"categories":["icecubo-footer"],"patternName":"icecubo/footer-2floors-gradual-glowing-bg","name":"Footer"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group has-handle-contrast-2-color has-text-color has-link-color">
    ...
    <hr class="wp-block-separator is-style-wide"/>
    <!-- /wp:separator -->
    <!-- wp:pattern {"slug":"icecubo/footer-2floors-inner"} /-->
</div>
<!-- /wp:group --></div></footer>
<!-- /wp:cover -->