 ...
 */
?>
<!-- wp:columns {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|large"}}}} -->
<div class="wp-block-columns" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--large)"><!-- wp:column {"width":"60%"} -->
...
<p class="has-small-font-size" style="line-height:1.6">Lorem ipsum dolor sit amet</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->