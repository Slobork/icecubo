 ...
 */
?>
<!-- wp:cover {"gradient":"darko-to-primary-radial-gradual","isDark":false,"align":"full","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|x-large","top":"var:preset|spacing|medium"},"margin":{"top":"0","bottom":"0"}}}} -->
...
<!-- wp:media-text {"align":"","mediaPosition":"right","mediaType":"image","mediaSizeSlug":"large","style":{"spacing":{"margin":{"top":"var:preset|spacing|xx-large"}}},"textColor":"white"} -->
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile has-white-color has-text-color" style="margin-top:var(--wp--preset--spacing--xx-large)"><div class="wp-block-media-text__content"><!-- wp:paragraph {"align":"center","fontSize":"large"} -->
