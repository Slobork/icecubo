 ...
 */
?>
<!-- wp:cover {"gradient":"darko-to-primary-linear-gradual","isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}}} -->
...
<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile has-white-color has-text-color"><div class="wp-block-media-text__content"><!-- wp:heading {"level":3,"textColor":"highlight-3"} -->
