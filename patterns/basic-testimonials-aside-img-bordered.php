 ...
 * Slug: icecubo/basic-testimonials-aside-image-bordered
 * Categories: icecubo-basic-testimonials
 */
?>
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|small","right":"var:preset|spacing|small"}},"border":{"width":"1px"}},"borderColor":"tint-3","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
...
<p class="is-style-default has-small-font-size">— John Doe, JDinc</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-small-font-size">— Jane Doe, JDinc</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
