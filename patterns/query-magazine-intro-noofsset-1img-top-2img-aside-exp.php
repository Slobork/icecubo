 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["icecubo-query-magazine-intro"],"patternName":"icecubo/query-magazine-intro-noofsset-1img-top-2img-aside-exp","name":"No offset, two columns: 1st with image at the top, 2nd image aside (Expand)."},"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|x-large"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"darko-down-bottom","layout":{"type":"default"}} -->
...
<div class="wp-block-column is-vertically-aligned-top"><!-- wp:paragraph {"className":"is-style-default","style":{"spacing":{"margin":{"top":"var:preset|spacing|medium"}}}} -->
