...
<h2 class="has-text-align-center">With our best feature get great results!</h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-white-ice-color has-text-color has-large-font-size">We have you backed!</p>
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"textAlign":"center"} -->
<h2 class="has-text-align-center">With another feature get even more results!</h2>
<!-- /wp:heading -->
