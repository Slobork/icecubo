 ...
 */
?>
<!-- wp:cover {"customGradient":"linear-gradient(180deg,rgb(28,31,37) 0%,rgb(149,99,173) 100%)","contentPosition":"top center","isDark":false,"align":"full"} -->
<div class="wp-block-cover alignfull is-light has-custom-content-position is-position-top-center"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim has-background-gradient" style="background:linear-gradient(180deg,rgb(28,31,37) 0%,rgb(149,99,173) 100%)"></span><div class="wp-block-cover__inner-container">
