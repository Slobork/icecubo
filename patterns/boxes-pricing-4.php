...
// phpcs:ignore
/**
 * Title: Pricing boxes 4
 * Slug: icecubo/boxes-pricing-4
 * Categories: icecubo-boxes
 */
?>
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"white-ice","className":"with-text-alignment"} -->
<div class="wp-block-column with-text-alignment has-white-ice-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-small","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"},"margin":{"bottom":"var:preset|spacing|x-large"}}},"backgroundColor":"highlight-2","layout":{"type":"constrained"}} -->
...
<p class="has-xl-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px">Basic</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"1rem"}}},"fontSize":"small"} -->
<p class="has-text-align-center has-small-font-size" style="margin-top:1rem">Feature item #</p>
<!-- /wp:paragraph -->

<!-- wp:separator {"style":{"spacing":{"margin":{"top":"5px","bottom":"5px"}}},"backgroundColor":"gray-dark","className":"is-style-wide"} -->
...
<!-- wp:column {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"backgroundColor":"white-ice","className":"with-text-alignment"} -->
<div class="wp-block-column with-text-alignment has-white-ice-background-color has-background" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-small","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"},"margin":{"bottom":"var:preset|spacing|x-large"}}},"backgroundColor":"highlight-2","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-highlight-2-background-color has-background" style="margin-bottom:var(--wp--preset--spacing--x-large);padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"fontSize":"xl"} -->
<p class="has-xl-font-size" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px">Professional</p>
<!-- /wp:paragraph -->
