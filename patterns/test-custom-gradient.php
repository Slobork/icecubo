...
// phpcs:ignore
/**
 * Title: Test custom gradient.
 * Slug: icecubo/header-test-cover-gradient
 * Categories: icecubo-header
 */ 
?>
<!-- wp:cover {"customGradient":"var(--wp--custom--gradient-radial-focus-20-primary)","contentPosition":"center center","isDark":false,"align":"full","style":{"spacing":{"padding":{"bottom":"5rem"}}}} -->
<div class="wp-block-cover alignfull is-light" style="padding-bottom:5rem"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim has-background-gradient" style="background:var(--wp--custom--gradient-radial-focus-20-primary)"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|x-small"}}},"layout":{"type":"constrained"}} -->
