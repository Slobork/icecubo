 ...
 */
?>
<!-- wp:cover {"tagName":"header","dimRatio":60,"gradient":"primary-to-transparent-rushly-radial","contentPosition":"center center","isDark":false,"metadata":{"categories":["icecubo-headerhero"],"patternName":"icecubo/header-hero-gradient-rushly-primary-transparent","name":"Header"},"align":"full","style":{"spacing":{"padding":{"bottom":"5rem","top":"var:preset|spacing|xxx-small"}},"elements":{"link":{"color":{"text":"var:preset|color|handle-contrast-2"}},"heading":{"color":{"text":"var:preset|color|classy-3"}}}},"textColor":"handle-contrast-2"} -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-handle-contrast-3-color has-classy-3-background-color has-text-color has-background has-link-color wp-element-button">Start now!</a></div>
<!-- /wp:button --></div>
