 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["icecubo-query-magazine-intro"],"patternName":"icecubo/query-magazine-intro-split-1img-top-2grid-img-top","name":"Offset split posts: 1st prominent post with image at the top. 2nd grid of posts."},"style":{"spacing":{"blockGap":"1px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"darko-down-bottom","layout":{"type":"default"}} -->
<div class="wp-block-group has-darko-down-bottom-color has-text-color has-link-color"><!-- wp:query {"queryId":0,"query":{"pages":0,"offset":"0","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","type":"constrained","inherit":false,"perPage":"1"},"layout":{"type":"default"}} -->
