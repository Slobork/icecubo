...
<div class="wp-block-group has-primary-dark-color has-text-color has-link-color" style="border-width:2px;border-radius:10px;padding-top:5px;padding-right:20px;padding-bottom:5px;padding-left:20px"><!-- wp:paragraph {"className":"is-style-default","textColor":"base"} -->
