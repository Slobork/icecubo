 ...
 */
?>
<!-- wp:cover {"metadata":{"name":"Header"},"tagName":"header","url":"<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/ice-cubes.png","alt":"IceCubo Theme Placeholder Image","dimRatio":40,"overlayColor":"tint-very-light-2","isUserOverlayColor":true,"minHeight":80,"minHeightUnit":"vh","contentPosition":"center center","isDark":false,"metadata":{"categories":["icecubo-headerhero"],"patternName":"icecubo/header-hero-cover-full-img-light-cta-left","name":"Header With A Full Background Image As A Cover (Light Image, Dark Text Set). Call To Action On The Left."},"align":"full","className":"is-style-default","style":{"color":{"duotone":"unset"}},"textColor":"primary-dark","layout":{"type":"constrained"}} -->
