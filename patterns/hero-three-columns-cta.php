...
<!-- wp:columns {"style":{"spacing":{"margin":{"top":"var:preset|spacing|xx-large"}}}} -->
<div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--xx-large)"><!-- wp:column -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"align":"center","textColor":"white"} -->
<p class="has-text-align-center has-white-color has-text-color">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
<!-- /wp:paragraph -->
