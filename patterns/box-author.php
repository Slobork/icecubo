...
<div class="wp-block-group with-text-alignment has-white-ice-background-color has-background" style="padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:avatar {"isLink":true,"align":"center","style":{"border":{"radius":"50px"}}} /-->
