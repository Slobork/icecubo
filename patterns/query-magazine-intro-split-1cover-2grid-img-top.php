 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["icecubo-query-magazine-intro"],"patternName":"icecubo/query-magazine-intro-split-1cover-2grid-img-top","name":"Offset split posts: 1st cover post. 2nd grid of posts with image first."},"style":{"spacing":{"blockGap":"1px"},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}},"textColor":"darko-down-bottom","layout":{"type":"default"}} -->
<div class="wp-block-group has-darko-down-bottom-color has-text-color has-link-color"><!-- wp:query {"queryId":0,"query":{"perPage":"1","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false}} -->
<div class="wp-block-query"><!-- wp:post-template {"className":"is-style-default","layout":{"type":"default","columnCount":3}} -->
<!-- wp:cover {"useFeaturedImage":true,"dimRatio":70,"overlayColor":"darko","isUserOverlayColor":true,"layout":{"type":"constrained"}} -->
...
<!-- wp:query {"queryId":0,"query":{"perPage":"6","pages":0,"offset":"1","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false}} -->
<div class="wp-block-query"><!-- wp:post-template {"style":{"spacing":{"blockGap":"1px"}},"layout":{"type":"grid","columnCount":3}} -->
