 ...
 */
?>
<!-- wp:cover {"metadata":{"name":"Header"},"tagName":"header","gradient":"darko-to-primary-linear-transit-corner","contentPosition":"center center","metadata":{"categories":["icecubo-headerhero"],"patternName":"icecubo/header-hero-cover-gradient-diagonal-transit-media-text-cta","name":"Header with hero. Call to action after the list items. Cover with diagonal transit background."},"align":"full","style":{"spacing":{"padding":{"bottom":"5rem","top":"var:preset|spacing|xxx-small"}}}} -->
